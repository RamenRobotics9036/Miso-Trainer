...
public class SwerveSimTest {
  ...
  void rotationTest() {
    ...
    try {
      ...
      assertAll(
          () -> assertEquals(-0.785,
              m_swerve.m_frontLeft.getPosition().angle.getRadians(),
              0.001,
              "FL angle"),
          () -> assertEquals(0.785,
              m_swerve.m_frontRight.getPosition().angle.getRadians(),
              0.001,
              "FR angle"),
          () -> assertEquals(0.785,
              m_swerve.m_backLeft.getPosition().angle.getRadians(),
              0.001,
              "BL angle"),
          () -> assertEquals(-0.785,
              m_swerve.m_backRight.getPosition().angle.getRadians(),
              0.001,
              "BR angle"));
      // has not moved yet
      assertAll(
          () -> assertEquals(0, m_swerve.m_frontLeft.getPosition().distanceMeters, 0.001, "FL m"),
          () -> assertEquals(0, m_swerve.m_frontRight.getPosition().distanceMeters, 0.001, "FR m"),
          () -> assertEquals(0, m_swerve.m_backLeft.getPosition().distanceMeters, 0.001, "BL m"),
          () -> assertEquals(0, m_swerve.m_backRight.getPosition().distanceMeters, 0.001, "BR m"));
      ...
      assertAll(
          () -> assertEquals(-0.033 / m_DistanceErrorFactor,
              m_swerve.m_frontLeft.getPosition().distanceMeters,
              0.001,
              "FL m"),
          () -> assertEquals(0.033 / m_DistanceErrorFactor,
              m_swerve.m_frontRight.getPosition().distanceMeters,
              0.001,
              "FR m"),
          () -> assertEquals(-0.033 / m_DistanceErrorFactor,
              m_swerve.m_backLeft.getPosition().distanceMeters,
              0.001,
              "BL m"),
          () -> assertEquals(0.033 / m_DistanceErrorFactor,
              m_swerve.m_backRight.getPosition().distanceMeters,
              0.001,
              "BR m"));
      ...
      assertAll(
          () -> assertEquals(0.062 / m_DistanceErrorFactor,
              m_swerve.m_gyro.getRotation2d().getRadians(),
              0.001,
              "gyro rotation"),
          () -> assertEquals(-3.542 / m_DistanceErrorFactor,
              m_swerve.m_gyro.getAngle(),
              0.001,
              "gyro angle"));
